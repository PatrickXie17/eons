...
def feed_forward_regression(weight, *args):
    """
...
def train_regression(X_train, X_test, y_train, y_test, loss_fun, thred, max_iter, q):
    diff = 1000
    counter = 0
    ...
    while (diff > thred) and (counter < max_iter):
        o_weight = weight
        k = scipy.optimize.fmin_l_bfgs_b(feed_forward_regression, x0=weight,
